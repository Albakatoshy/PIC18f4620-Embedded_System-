...
void MSSP_I2C_Send_1_Byte(uint8 slave_add, uint8 _data){
    ...
    ret = I2c_Master_Write_blocking(&i2c_obj, slave_add, &slave_ack);
    ret = I2c_Master_Write_blocking(&i2c_obj, _data, &slave_ack);
...
int main() { 
    ...
    i2c_obj.i2c_cfg.i2c_mode = I2C_MASTER_MODE_CFG,
    i2c_obj.i2c_cfg.i2c_mode_cfg = I2C_MASTER_MODE_DEFINED_CLOCK_CFG;
    i2c_obj.i2c_cfg.i2c_SMBus_control = I2C_SMBus_DISABLE_CFG;
    i2c_obj.i2c_cfg.i2c_slew_rate = I2C_SLEW_RATE_DISABLE_CFG;
