...
# 12 "./MCAL_layer/CCP/../GPIO/../std_libraries.h"
...
# 12 "./MCAL_layer/CCP/../GPIO/../compiler.h" 2
...
# 36 "./MCAL_layer/CCP/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 14 "./MCAL_layer/CCP/../Interrupt/mcal_internal_interrupt.h"
...
# 60 "./MCAL_layer/CCP/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0 ,
    INTERRUPT_HIGH_PRIORITY,

}interrupt_priority_cfg;
# 15 "./MCAL_layer/CCP/../Interrupt/mcal_internal_interrupt.h" 2
...
static void CCP_CAPTURE_MODE_TIMER_SELECT(const ccp_config_t *ccp_obj);
    ...
    static void (*CCP1_IntrerruptHandler)(void) = ((void*)0) ;



    static void (*CCP2_IntrerruptHandler)(void) = ((void*)0) ;
