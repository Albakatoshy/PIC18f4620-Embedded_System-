...
# 2 "<built-in>" 2
# 1 "ECU_layer/LCD/ecu_chr_lcd.c" 2
# 1 "ECU_layer/LCD/ecu_chr_lcd.h" 1
# 15 "ECU_layer/LCD/ecu_chr_lcd.h"
...
# 15 "ECU_layer/LCD/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 36 "ECU_layer/LCD/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 16 "ECU_layer/LCD/ecu_chr_lcd.h" 2
# 1 "ECU_layer/LCD/ecu_chr_lcd_cfg.h" 1
# 17 "ECU_layer/LCD/ecu_chr_lcd.h" 2
# 42 "ECU_layer/LCD/ecu_chr_lcd.h"
typedef struct{
...
# 2 "ECU_layer/LCD/ecu_chr_lcd.c" 2
...
Std_ReturnType lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd , uint8 row , uint8 column , const uint8 _chr[] , uint8 memory_pos){
    ...
    if (((void*)0) == lcd ){
        ...
        ret = lcd_4bit_send_command(lcd , (0x40 +(memory_pos*8)));
...
Std_ReturnType lcd_8bit_send_command(const chr_lcd_8bit_t *lcd , uint8 command){
    Std_ReturnType ret = (Std_ReturnType)0x01 ;
    uint8 l_counter_send_commands = 0 ;
    if (((void*)0) == lcd ){
        Std_ReturnType ret = (Std_ReturnType)0x00 ;
    }
    else{
        ...
        for (l_counter_send_commands = 0 ; l_counter_send_commands < 8 ; l_counter_send_commands++ ){
...
Std_ReturnType lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd , uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01 ;
    uint8 l_counter_send_data = 0 ;
    if (((void*)0) == lcd ){
        Std_ReturnType ret = (Std_ReturnType)0x00 ;
    }
    else{
        ret = gpio_pin_write_logic(&(lcd->lcd_rs_pin),GPIO_HIGH);
        for (l_counter_send_data = 0 ; l_counter_send_data < 8 ; l_counter_send_data++ ){
...
Std_ReturnType lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd , uint8 row , uint8 column , const uint8 _chr[] , uint8 memory_pos){
    ...
    if (((void*)0) == lcd ){
        ...
        ret = lcd_8bit_send_command(lcd , (0x40 +(memory_pos*8)));
        for (l_lcd_counter=0 ; l_lcd_counter<=7 ; l_lcd_counter++){
