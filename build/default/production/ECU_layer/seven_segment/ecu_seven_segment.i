...
# 14 "ECU_layer/seven_segment/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 12 "ECU_layer/seven_segment/../../MCAL_layer/GPIO/../compiler.h" 2
...
# 14 "ECU_layer/seven_segment/ecu_seven_segment.h" 2
...
# 2 "ECU_layer/seven_segment/ecu_seven_segment.c" 2
...
Std_ReturnType seven_seg_initialize(const sev_segment_t *sev_seg){
    ...
    if (((void*)0) == sev_seg){
        ...
        ret = gpio_pin_intialize(&(sev_seg->sev_segment_pins[0]));
        ret = gpio_pin_intialize(&(sev_seg->sev_segment_pins[1]));
        ret = gpio_pin_intialize(&(sev_seg->sev_segment_pins[2]));
        ret = gpio_pin_intialize(&(sev_seg->sev_segment_pins[3]));
    }
...
Std_ReturnType seven_seg_write_number(const sev_segment_t *sev_seg , uint8 number){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if ((((void*)0) == sev_seg) && (number > 9)){
        ret = (Std_ReturnType)0x00;
    }
    else{
        gpio_pin_write_logic(&(sev_seg->sev_segment_pins[0]),(number) & 0x01);
        gpio_pin_write_logic(&(sev_seg->sev_segment_pins[1]),(number>>1) & 0x01);
        gpio_pin_write_logic(&(sev_seg->sev_segment_pins[2]),(number>>2) & 0x01);
        gpio_pin_write_logic(&(sev_seg->sev_segment_pins[3]),(number>>3) & 0x01);
    }
