...
# 14 "MCAL_layer/TIMER2/../Interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_layer/TIMER2/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MCAL_layer/TIMER2/../Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_layer/TIMER2/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_layer/TIMER2/../Interrupt/mcal_interrupt_config.h" 2
# 60 "MCAL_layer/TIMER2/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0 ,
    INTERRUPT_HIGH_PRIORITY,

}interrupt_priority_cfg;
# 15 "MCAL_layer/TIMER2/../Interrupt/mcal_internal_interrupt.h" 2
# 19 "MCAL_layer/TIMER2/hal_timer2.h" 2
...
Std_ReturnType Timer2_Init(const timer2_config_t *_timer){
    ...
    if(((void*)0) == _timer){
        ...
        (T2CONbits.TMR2ON = 0);
        (T2CONbits.TOUTPS = _timer->Timer2_Postscale_Select);
        (T2CONbits.T2CKPS = _timer->Timer2_Prescaler_Select);
...
# 48 "MCAL_layer/TIMER2/hal_timer2.c"
        (INTCONbits.GIE=1);
        (INTCONbits.PEIE=1);
