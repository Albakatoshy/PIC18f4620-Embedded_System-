...
# 14 "MCAL_layer/TIMER3/../Interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_config.h" 2
# 60 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0 ,
    INTERRUPT_HIGH_PRIORITY,

}interrupt_priority_cfg;
# 15 "MCAL_layer/TIMER3/../Interrupt/mcal_internal_interrupt.h" 2
# 17 "MCAL_layer/TIMER3/hal_timer3.h" 2
# 43 "MCAL_layer/TIMER3/hal_timer3.h"
typedef struct {
...
# 2 "MCAL_layer/TIMER3/hal_timer3.c" 2
...
Std_ReturnType Timer3_Init(const timer3_config_t *_timer){
    ...
    if (((void*)0) == _timer){
        ...
        (T3CONbits.T3CKPS = _timer->timer3_Prescaler_val);
...
# 52 "MCAL_layer/TIMER3/hal_timer3.c"
        (INTCONbits.GIE=1);
        (INTCONbits.PEIE=1);
...
Std_ReturnType Timer3_ReadVal(const timer3_config_t *_timer , uint16 *readVal){
    ...
    if ((((void*)0) == _timer) && (((void*)0) == readVal)){
        ret = (Std_ReturnType)0x00 ;
    }
    else{
        l_TMR3L = TMR3L;
...
static __attribute__((inline)) void Timer3_mode_select(const timer3_config_t *_timer ){
    if(1 == _timer->timer3_mode){
        (T3CONbits.TMR3CS = 1);
        if(1 ==_timer->timer3_counter_Synchronization_select){
            (T3CONbits.T3SYNC = 1);
        }
        else if(0 == _timer->timer3_counter_Synchronization_select){
            (T3CONbits.T3SYNC = 0);
        }
        else{ }
    }
    else if (0 == _timer->timer3_mode){
        (T3CONbits.TMR3CS = 0);
    }
    else{ }
}
