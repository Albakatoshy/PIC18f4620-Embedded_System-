...
# 14 "MCAL_layer/ADC/../Interrupt/mcal_internal_interrupt.h"
...
# 36 "MCAL_layer/ADC/../Interrupt/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 60 "MCAL_layer/ADC/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0 ,
    INTERRUPT_HIGH_PRIORITY,

}interrupt_priority_cfg;
# 15 "MCAL_layer/ADC/../Interrupt/mcal_internal_interrupt.h" 2
...
static __attribute__((inline)) void adc_select_result_format(const adc_configuration_t *_adc);
static __attribute__((inline)) void adc_select_voltage_reference(const adc_configuration_t *_adc);
...
# 142 "MCAL_layer/ADC/hal_adc.c"
Std_ReturnType ADC_IsConversionDone(const adc_configuration_t *_adc , uint8 *conversion_status){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(_adc==((void*)0) || ((void*)0) == conversion_status ){
        ret= (Std_ReturnType)0x00;
    }
    else{
...
Std_ReturnType ADC_GetConversionResult(const adc_configuration_t *_adc , adc_result_t *conversion_result){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if((_adc==((void*)0) )|| (((void*)0) == conversion_result)){
        ret= (Std_ReturnType)0x00;
    }
    else{
...
static __attribute__((inline)) void adc_select_voltage_reference(const adc_configuration_t *_adc){
    if (_adc->voltage_reference == 0x01U){
        do{ADCON1bits.VCFG0 = 1; ADCON1bits.VCFG1 = 1; }while(0);
    }
    else if(_adc->voltage_reference == 0x00U){
