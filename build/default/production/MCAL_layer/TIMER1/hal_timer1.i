...
static __attribute__((inline)) void Timer1_oscillator_cfg_select(const timer1_config_t *_timer );
...
static __attribute__((inline)) void Timer1_oscillator_cfg_select(const timer1_config_t *_timer ){
    if(1 == _timer->timer1_oscillator_cfg){
        (T1CONbits.T1OSCEN= 1);
    }
    else if (0 == _timer->timer1_oscillator_cfg){
        (T1CONbits.T1OSCEN= 0);
    }
    else{ }
}
