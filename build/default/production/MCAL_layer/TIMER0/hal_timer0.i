...
# 12 "MCAL_layer/TIMER0/../GPIO/../compiler.h" 2
...
# 14 "MCAL_layer/TIMER0/../Interrupt/mcal_internal_interrupt.h"
...
# 60 "MCAL_layer/TIMER0/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0 ,
    INTERRUPT_HIGH_PRIORITY,

}interrupt_priority_cfg;
# 15 "MCAL_layer/TIMER0/../Interrupt/mcal_internal_interrupt.h" 2
...
static __attribute__((inline)) void Timer0_prescaler_value_select(const timer0_config_t *_timer );

static __attribute__((inline)) void Timer0_mode_select(const timer0_config_t *_timer );
static __attribute__((inline)) void Timer0_control_register_size(const timer0_config_t *_timer );
...
static __attribute__((inline)) void Timer0_prescaler_value_select(const timer0_config_t *_timer ){
        if (_timer->PrescalerEnable == 1){
            (T0CONbits.PSA = 0);
            T0CONbits.T0PS = _timer->Prescaler_val;
        }
        else if (0 == _timer->PrescalerEnable ){
            (T0CONbits.PSA = 1);
        }
}
...
static __attribute__((inline)) void Timer0_mode_select(const timer0_config_t *_timer ){
    if(0 == _timer->timer0_mode){
        ...
        (T0CONbits.T0CS = 1);
        if (1 == _timer->timer0_source_edge_select){
        (T0CONbits.T0SE = 1);
        }
        else if(0 == _timer->timer0_source_edge_select){
            (T0CONbits.T0SE = 0);
        }
        else{ }
    }
...
static __attribute__((inline)) void Timer0_control_register_size(const timer0_config_t *_timer ){
    if (1 == _timer->timer0_control_register_size){
        (T0CONbits.T08BIT = 1);
    }
    else if (0 == _timer->timer0_control_register_size){
        (T0CONbits.T08BIT = 0);
    }
    else{ }
}
