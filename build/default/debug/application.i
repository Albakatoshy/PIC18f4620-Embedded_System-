...
# 13 "./ECU_layer/seven_segment/ecu_seven_segment.h"
...
typedef struct {
    ...
    pin_config_t kepyad_col_pins[4];
}keypad_t;
...
# 16 "./ECU_layer/LCD/ecu_chr_lcd.h"
...
# 60 "./MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
...
void timer1_timer_init(void){
    timer1_config_t timer_obj = {
      ...
      .timer1_Prescaler_val = 2,
      .timer1_mode = 0,
      .timer1_read_write_mode = 0,
...
void timer1_counter_init(void){
    timer1_config_t counter_obj = {
      .TIMER0_InterruptHandler = TIMER1_DefaultInterruptHandler,
      .timer1_Prescaler_val = 0,
      .timer1_mode = 1,
      .timer1_read_write_mode = 0,
      .timer1_preloaded_value = 0,
      .timer1_counter_Synchronization_select = 0 ,
