...
Std_ReturnType gpio_pin_get_direction_status (const pin_config_t *_pin_config ,direction_t *dir_status ){
    ...
    if (((void*)0) == _pin_config || ((void*)0) == dir_status || _pin_config->pin > 8 -1)
    {
         ret = (Std_ReturnType)0x00;
    }
    else
    {
        *dir_status = ((*tris_register[_pin_config->port] >> _pin_config->pin) & (uint8)1 );
