...
# 14 "MCAL_layer/TIMER1/../Interrupt/mcal_internal_interrupt.h"
...
# 60 "MCAL_layer/TIMER1/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0 ,
    INTERRUPT_HIGH_PRIORITY,

}interrupt_priority_cfg;
# 15 "MCAL_layer/TIMER1/../Interrupt/mcal_internal_interrupt.h" 2
# 19 "MCAL_layer/TIMER1/hal_timer1.h" 2
# 51 "MCAL_layer/TIMER1/hal_timer1.h"
...
static __attribute__((inline)) void Timer1_read_write_mode_select(const timer1_config_t *_timer );


InterruptHandler TIMER1_InterruptHandler = ((void*)0) ;
...
Std_ReturnType Timer1_Init(const timer1_config_t *_timer){
    ...
    if (((void*)0) == _timer){
        ...
        (T1CONbits.T1CKPS = _timer->timer1_Prescaler_val );
        Timer1_read_write_mode_select(_timer);
...
static __attribute__((inline)) void Timer1_mode_select(const timer1_config_t *_timer ){
    if(1 == _timer->timer1_mode){
        (T1CONbits.TMR1CS = 1);
        if(1 ==_timer->timer1_counter_Synchronization_select){
            (T1CONbits.T1SYNC = 1);
        }
        else if(0 == _timer->timer1_counter_Synchronization_select){
            (T1CONbits.T1SYNC = 0);
        }
        else{ }
    }
    else if (0 == _timer->timer1_mode){
        (T1CONbits.TMR1CS = 0);
    }
    else{ }
}
...
static __attribute__((inline)) void Timer1_read_write_mode_select(const timer1_config_t *_timer ){
    if(1 == _timer->timer1_read_write_mode){
        (T1CONbits.RD16 = 1);
    }
    else if (0 == _timer->timer1_read_write_mode){
        (T1CONbits.RD16 = 0);
    }
    else{ }
}
